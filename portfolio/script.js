document.addEventListener('DOMContentLoaded', function() {
    const projects = [
        ...
        { id: 5, title: 'Rocket Mouse Video Game', description: 'A infinite runner video game written in TypeScript that utilizes Node.js. I followed a tutorial to complete this project and went further by implementing - power-ups.', tags: ['TypeScript', 'Video Game', 'Node.js'], url: 'projects/rocketMouse.html', image: '/assets/rocketmouse.png' },
        { id: 6, title: 'We Do That - Rediscover Community', description: 'Create, join and see the events surrounding you in your community. Connection has never been this easy!', tags: ['HTML-CSS', 'PHP', 'MySQL'], url: 'projects/weDoThat.html', image: '/assets/weDoThat.png'},
        ...
        { id: 8, title: 'Three.js Landing Page', description: 'Some experimentation with the landing page for a website using Three.js', tags: ['Three.js', 'JavaScript'], url: 'projects/landingPage.html', image: '/assets/landingPage.png' },
